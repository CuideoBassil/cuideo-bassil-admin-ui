...
import { useGetFeaturedBySectionQuery } from "@/redux/featured/featuredApi";
import Image from "next/image";
import ErrorMsg from "../common/error-msg";
import Pagination from "../ui/Pagination";
import FeaturedEditDelete from "./featured-edit-del";

const FeaturedTabless = () => {
  const {
    data: featured,
    isError,
    isLoading,
              ...
              <tbody>
                {[...currentItems.reverse()].map((item: any) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 font-normal text-[#55595b] flex justify-center items-center">
                      <div
...
export default FeaturedTabless;
